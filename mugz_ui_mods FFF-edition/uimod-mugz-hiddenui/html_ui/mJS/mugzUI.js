var hKey = 122; // Hud toggle. F11
var iKey = 120; // Ingame Markers (POI/Nameplates) toggle. F10 keybind.
var mKey = 121; // Footy Nameplates - F9
...
window.document.documentElement.style.setProperty('--igm-block-footy', (localStorage.getItem('mToggle') == 'true') ? 'block' : 'none');
window.document.documentElement.style.setProperty('--igm-flex-footy', (localStorage.getItem('mToggle') == 'true') ? 'flex' : 'none');
...
window.document.addEventListener("keyup", function (e) {
  if (e.keyCode == hKey) {
    ...
    setTimeout(function() { 
      ...
      window.document.documentElement.style.setProperty('--igm-flex', (localStorage.getItem('iToggle') == 'true') ? 'flex' : 'none'); */
	  window.document.documentElement.style.setProperty('--igm-flex-footy', (localStorage.getItem('mToggle') == 'true') ? 'flex' : 'none');
	  window.document.documentElement.style.setProperty('--igm-block-footy', (localStorage.getItem('mToggle') == 'true') ? 'flex' : 'none');
    }, 50);
  }
});
